...
public abstract class YandexTranslatorAPI {
	...
	protected static String apiKey = analyzer.translation.yandex.ApiKeys.YANDEX_API_KEY;
	...
	private static String inputStreamToString(final InputStream inputStream)
		...
		try {
			...
			throw new Exception(
					"[yandex-translator-api] Error reading translation stream.",
					ex);
		} /*
	...
	protected static void validateServiceState() throws Exception {
		if (apiKey == null || apiKey.length() < 27) {
			throw new RuntimeException(
					"INVALID_API_KEY - Please set the API Key with your Yandex API Key");
		}
	}
