 ...
 */
package analyzer.translation.yandex;
...
public final class Detect extends YandexTranslatorAPI {
	...
	public static Language execute(final String text) throws Exception {
		...
		final String params = PARAM_API_KEY
				+ URLEncoder.encode(apiKey, ENCODING) + PARAM_TEXT
	...
	private static void validateServiceState(final String text)
		...
		if (byteLength > 10240) { // TODO What is the maximum text length
									// allowable for Yandex?
			throw new RuntimeException(
					"TEXT_TOO_LARGE - Yandex Translator (Detect) can handle up to 10,240 bytes per request");
		}
	...
	public static void main(String[] args) {
		try {
			...
			Language translation = Detect
					.execute("The quick brown fox jumps over the lazy dog.");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			TextAnalyzer.logger.info(e.getMessage());
			// e.printStackTrace();
		}
	}
