...
/**
 * Interface deciding the tag structure
 * 
 * @author forsstho
 * 
 */
public interface TagInterface {
	...
	void addTwitterTag(ObjectOutput oo);

	TwitterProfile getTwitterProfileInformation(String userid);

	boolean addPicsomTag(String url, String tag, String photouid,
			String backendid, String visualobjectid);

	boolean addPicsomTag(String tag, String photouid, String backendid,
